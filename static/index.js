...
(function(w) {
    ...
    function shareText(score) {
        ...
        if (score <= 49) return '老奶奶不太高兴';
        if (score <= 99) return '老奶奶高兴了一点';
        if (score <= 149) return '奶奶比较满意';
        if (score <= 199) return '奶奶十分满意';
        if (score <= 249) return '奶奶非常滴满意'
        return '你的行为引起公愤';
    }
    ...
    function initSetting() {
        ...
        document.getElementsByTagName("title")[0].innerText = cookie("title") ? cookie("title") : "放烟花游戏";
        if (cookie("keyboard")) {
